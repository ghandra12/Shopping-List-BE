    ...
    public partial class InitialDatabaseConfiguration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListsProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ListsProducts_Lists_ListId",
                        column: x => x.ListId,
                        principalTable: "Lists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListsProducts_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListsProducts_ListId",
                table: "ListsProducts",
                column: "ListId");

            migrationBuilder.CreateIndex(
                name: "IX_ListsProducts_ProductId",
                table: "ListsProducts",
                column: "ProductId");
